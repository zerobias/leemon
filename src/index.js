 ...
 * @returns {(0 | 1)}
 */
export function millerRabinInt(
  x: number[],
  b: number
): Bool {
 ...
 * @returns {number[]}
 */
export function randProbPrimeRounds(
  k: number,
  n: number
): number[] {
 ...
 * @returns {(1 | 0)}
 */
export function negative(x: number[]) { //TODO Flow Bool type inference
